...
export function persistAttribution(storage:Pick<Storage,'getItem'|'setItem'>,value:Attribution){if(!storage.getItem(ATTRIBUTION_KEY))storage.setItem(ATTRIBUTION_KEY,JSON.stringify(value));return readAttribution(storage);}
